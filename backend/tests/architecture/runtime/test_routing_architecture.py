...
def test_routing_boundary_neutrality():
    """
    AST-based architecture test to ensure RoutingEngine and RouteDecision
    ...
    forbidden_terms = {
        ...
        "adaptation", "fastapi", "pydantic", "application", "model", "models"
    }

    core_dir = Path(__file__).resolve().parents[4] / "src" / "runtime" / "core"
    
    files_to_check = [
        core_dir / "route_decision.py",
        core_dir / "routing_engine.py"
    ]
