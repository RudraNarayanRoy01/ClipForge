...
| `08_REPOSITORY_INSPECTION.md` | Repeatable inspection techniques | Deferred | Governance Lead | 6A.2 | 6A.1 manual | Event-driven | Semantic |
| `09_BATCH_WORKFLOW.md` | Batch sizing, scope, evidence rules | Deferred | TPM | 6A.6 | Pilot learnings | Event-driven | Semantic |
| `10_SPRINT_WORKFLOW.md` | Sprint planning, review, certification | Deferred | TPM | 6A.6 | Sprint learnings | Event-driven | Semantic |
| `11_MILESTONE_WORKFLOW.md` | Milestone readiness, closeout | Deferred | TPM / Architecture Owner | 6A.6 | Certification strategy | Event-driven | Semantic |
...
| `templates/ARCHITECTURE_VERIFICATION_TEMPLATE.md` | Record dependency, runtime drift | Deferred | Architecture Owner | 6A.4 | 06_ARCHITECTURE_VERIFICATION.md | Event-driven | Semantic |
| `templates/CERTIFICATION_TEMPLATE.md` | Criterion-to-evidence record | Deferred | Certifier | 6A.5 | 07_CERTIFICATION_STANDARD.md | Event-driven | Semantic |
